...
<body translate="no" >
  ...
  <button class="button-signup"><span>login</span></button>
  <div class="block-inner">
   <form id="form" method="post" action="/login">
      <br><br><br><br><br><br>
      <label id="login_label" style="text-align: center;"><img src="${path}/resources/src/login.svg" width="234px"
        height="51px" type="image / svg + xml" codebase="http://www.adobe.com / svg / viewer / install " /></label>
      ID<input type='text' name='id' id='id'autocomplete="off" placeholder="아이디를 입력해주세용 :)" onfocus="this.placeholder='아이디를 입력해주세용 XD'"
      onblur="this.placeholder='아이디를 입력해주세용 :P'"

      />
      PASSWORD<input type='password' id='password1'  name='password1' autocomplete="off" placeholder="비밀번호를 입력해주세용 :)" onfocus="this.placeholder='비밀번호를 입력해주세용 XD'"
      onblur="this.placeholder='비밀번호를 입력해주세용 :P'"/>
      <p class="description" >Welcome to N'Pain!<br> * 'pain'은 프랑스어로 '빵' 입니다! :)<br><br> id:npain<br> pw:1234</p>
      <!-- <input type='submit'> -->
      <div class="form-action" value='로그인'>
